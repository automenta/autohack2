...
public record ApplyCommand(Context context) implements Command {
    ...
    public void execute(String[] args) {
        try {
            ...
            String currentDiff = context.getDiff(); // Assuming Container has getDiff() method
            ...
            try {
                ...
                context.setDiff(null); // Clear the diff after application
            } catch (Exception e) {
